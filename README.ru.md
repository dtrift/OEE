...
сообщений на `oee/line1/#`; запуск — `RELEASE=1 scripts/bench.sh
scenarios/soak.toml 42`: debug-дефолт на ~0.6 ГБ CSV ползёт — 184 с
против 6 с у узла A; оба варианта запуска и измеренные числа — в
[`docs/rus/soak.md`](docs/rus/soak.md)).
